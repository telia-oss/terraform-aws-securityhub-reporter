...
PS_CONTROLS_IDS_API_URL = os.environ.get('PS_CONTROLS_IDS_API_URL')
PS_CONTROLS_IDS_API_KEY = os.environ.get('PS_CONTROLS_IDS_API_KEY')
PS_CONTROLS_IDS_API_RESOURCE_PATH = os.environ.get('PS_CONTROLS_IDS_API_RESOURCE_PATH')


control_ids_resolver = ControlIdsResolver(SECURITY_CONTROLS, PS_CONTROLS_IDS_API_URL, PS_CONTROLS_IDS_API_KEY, PS_CONTROLS_IDS_API_RESOURCE_PATH)
